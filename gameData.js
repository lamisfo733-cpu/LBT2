...
// ... بعد المرحلة السابعة في gameData.js

const stages = [
    // ... المراحل 1-7 السابقة
    // ... أضف بعد المرحلة السابعة مباشرة:

    {
        id: 8,
        title: "تحدي البرمجة والألعاب",
        icon: "🎮",
        unlockDate: new Date('2025-01-19T00:00:00'),
        description: "أصلح الكود ثم العب لعبة المنصات مثل ماريو!",
        challenges: [
            {
                type: "code",
                question: "أصلح الخطأ في الكود التالي ليحرك الروبوت للأمام:",
                code: `function moveRobot() {
  // أصلح هذه الدالة لتحريك الروبوت
  robit.moveForward(); // يوجد خطأ إملائي هنا
}`,
                correctAnswer: "robot.moveForward();",
                hint: "تحقق من كتابة كلمة robot",
                points: 20
            },
            {
                type: "game",
                gameType: "platformer",
                question: "استخدم الأسهم للتحكم، اجمع 10 عملات لتكمل المرحلة!",
                points: 30
            }
        ]
    },
    {
        id: 9,
        title: "مختبر بلاكرس الكيميائي",
        icon: "🔬",
        unlockDate: new Date('2025-01-26T00:00:00'),
        description: "اخلط الكيماويات للحصول على التركيبة الصحيحة",
        challenges: [
            {
                type: "lab",
                question: "اختر الكيماويات الصحيحة لصنع وقود الروبوت:",
                chemicals: ["H₂O", "CO₂", "C₈H₁₈", "O₂", "N₂", "CH₄"],
                correctCombination: ["C₈H₁₈", "O₂"],
                hint: "وقود الروبوت يحتاج إلى وقود وأكسجين للاحتراق",
                points: 25
            },
            {
                type: "lab",
                question: "اصنع محلول تنظيف للروبوت:",
                chemicals: ["H₂O", "NaOH", "HCl", "NaCl", "CH₃COOH"],
                correctCombination: ["H₂O", "CH₃COOH"],
                hint: "حمض ضعيف مع الماء للتنظيف الآمن",
                points: 25
            }
        ]
    },
    {
        id: 10,
        title: "تحدي تصميم الروبوت",
        icon: "🤖",
        unlockDate: new Date('2025-02-02T00:00:00'),
        description: "صمم روبوتك الخاص وقم باختباره",
        challenges: [
            {
                type: "design",
                question: "اسحب القطع لبناء روبوت FTC:",
                components: ["المحرك", "المتحكم", "المستشعر", "العجلات", "الذراع", "البطارية"],
                requiredComponents: ["المتحكم", "المحرك", "العجلات", "البطارية"],
                hint: "كل روبوت يحتاج إلى تحكم وحركة وطاقة",
                points: 20
            },
            {
                type: "simulation",
                question: "اختبر روبوتك في حلبة FTC:",
                points: 30,
                gameType: "robot_simulator"
            }
        ]
    }
];
